<?php
/* Smarty version 4.1.1, created on 2025-02-12 04:25:18
  from 'C:\OSPanel\domains\internetShopByPHP\views\default\cart.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_67abf87e3e9680_02794276',
...
function content_67abf87e3e9680_02794276 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="ru">
    <head>
                ...
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-12">
                        <div class="card rounded-3 mb-4">
                            <div class="card-body p-4">
                                <div class="row d-flex justify-content-center align-items-center">
                                    <div class="col-md-2">
                                        <img src="img/products/1.png" alt="Product 1" class="img-fluid rounded-3" alt="">
                                    </div>
                                    <a href="#" class="col-md-4 col-lg-4 col-xl-4 nav-link active" style="color: black;">Продукт</a>
                        ...
                        <ul class="nav nav-pills order">
                            <li class="nav-item">
                                <a class="nav-link active order" href="#">Оформить заказ</a>
                            </li>
                        </ul>
                    </div>
                </div>
