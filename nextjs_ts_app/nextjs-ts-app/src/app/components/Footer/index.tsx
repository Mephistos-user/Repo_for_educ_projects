    ...
    return (
        ...
        <div className="mx-auto max-w-screen-xl text-center">
            ...
            <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
                ...
                <li>
                    <Link href="#" className="mr-4 hover:underline md:mr-6">Premium</Link>
                </li>
                <li>
                    <Link href="#" className="mr-4 hover:underline md:mr-6 ">Campaigns</Link>
                </li>
                <li>
            ...
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2021-2022 <Link href="#" className="hover:underline">Flowbite™</Link>. All Rights Reserved.</span>
        </div>
        </footer>
